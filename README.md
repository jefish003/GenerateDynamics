...
'Aizawa' - The Aizawa system $dx/dt = (z-b)x-dy$, $dy/dt = dx+(z-b)y$, $dz/dt = c+az-z^3/3 -(x^2+y^2)(1+ez)+fz$. The parameters should be listed as $[a,b,c,d,e,f]$. One suggested example set $[0.95,0.7,0.6,3.5,0.25,0.1]$
